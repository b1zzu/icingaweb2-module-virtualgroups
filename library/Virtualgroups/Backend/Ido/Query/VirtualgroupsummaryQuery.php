...
namespace Icinga\Module\Virtualgroups\Backend\Ido\Query;
 ...
 */
class VirtualgroupsummaryQuery extends IdoQuery
{
    /**
     * {@inheritdoc}
     */
    ...
    protected $virtualGroupKey;

    /**
     * VirtualgroupsummaryQuery constructor.
     * @param $ds
     * @param String $virtualGroupKey
     * @param null $columns
     */
    public function __construct($ds, $virtualGroupKey, $columns = null)
    {
        $this->virtualGroupKey = $virtualGroupKey;
    ...
    {
        list($type, $name) = $this->customvarNameToTypeName($this->virtualGroupKey);
        ...
        $hosts = $this->createSubQuery(
            ...
            array(
                ...
                'hostgroup_alias' => $this->virtualGroupKey,
                'hostgroup_name'  => $this->virtualGroupKey,
                'object_type',
        ...
        $hosts->select()->where("$alias.varvalue IS NOT NULL");
        ...
        $services->select()->where("$alias.varvalue IS NOT NULL");
